...
contract SCRepToken is Controlled {
    ...
    SCRepTokenFactory public tokenFactory;

////////////////
// Constructor
////////////////

    /// @notice Constructor to create a SCRepToken
    /// @param _tokenFactory The address of the SCRepTokenFactory contract that
    ...
    function SCRepToken(
        ...
        tokenFactory = SCRepTokenFactory(_tokenFactory);
        name = _tokenName;                                 // Set the name
        decimals = _decimalUnits;                          // Set the decimals
        symbol = _tokenSymbol;                             // Set the symbol
        parentToken = SCRepToken(_parentToken);
...
///////////////////
    ...
    function doTransfer(address _from, address _to, uint _amount
           ...
           if (isContract(controller)) {
               if (!RepTokenController(controller).onTransfer(_from, _to, _amount))
               throw;
           }
    ...
    function approve(address _spender, uint256 _amount) returns (bool success) {
        ...
        if (isContract(controller)) {
            if (!RepTokenController(controller).onApprove(msg.sender, _spender, _amount))
                throw;
        }
...
////////////////
    ...
    /// @return The address of the new SCRepToken Contract
    function createCloneToken(
        ...
        SCRepToken cloneToken = tokenFactory.createCloneToken(
            this,
            _snapshotBlock,
            _cloneTokenName,
            _cloneDecimalUnits,
...
////////////////
    ...
    function ()  payable {
        if (isContract(controller)) {
            if (! RepTokenController(controller).proxyPayment.value(msg.value)(msg.sender))
                throw;
        } else {
            throw;
        }
...
contract SCRepTokenFactory {
    ...
    function createCloneToken(
        ...
        SCRepToken newToken = new SCRepToken(
            this,
            _parentToken,
            _snapshotBlock,
            _tokenName,
